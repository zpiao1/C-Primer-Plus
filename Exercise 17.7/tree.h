...
/* operation:       determine if tree if full               */
/* preconditions:   ptree points to a tree                  */
/* postconditions:  function returns true if tree is        */
...
/*                  the tree                                */
/* preconditions:   ptree points to a tree                  */
/*                  pfun points to a functions that takes   */
/*                  an Item argument and has no return      */
/*                  value                                   */
/* postcondition:   the function pointed to by pfun is      */
/*                  executed once for each item in tree     */
void Traverse(const Tree * tree, void (* pfun)(Item item));
...
/* operation:       search the word provided                */
/* precondition:    ptree points to a tree                  */
/*                  pfun points to a function that takes    */
/*                  an Item argument and has no return      */
/*                  value                                   */
/* postcondition:   the function prints the information of  */
/*                  the word if it is found, or error       */
/*                  message otherwise                       */
